...
//         "https://kooviot.vercel.app/invoice/submit",
...
//   return (
//     <div className="p-6 m-10 rounded-lg bg-gradient-to-b from-white to-indigo-100">
//       <ToastContainer hideProgressBar />
//       <h1 className="text-2xl font-bold text-center text-blue-800 mb-6">Invoice Entry</h1>
...
//         <InputField label="No. of Pieces" type="number" value={pieces} onChange={setPieces} error={errors.pieces} />
//       </div>
