...
export default function Header() {
  ...
  //   const headerEle = ["Home", "Issue", "Order"]
  //   const svgIcon =[`<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <header className="bg-background sticky top-0 z-20 text-foreground shadow-lg border-b">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex w-96 flex-row justify-between">
          ...
          <div className="flex" onClick={() => router.push('/OrderDetails')}>
            <span>
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex" onClick={() => router.push('/IssueTracker')}>
            <span>
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div onClick={() => setIsMenuOpen(true)} className="hidden md:flex w-96 flex-row justify-between">
          <div onClick={() => salesperson.role === "admin" ? router.push('/admin') : router.push('/')} className="flex">
            <span>
        ...
        <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} fixed top-[4.1rem] left-0 right-0 bottom-0  bg-gray-800 bg-opacity-50`}>
          <div className="flex flex-col justify-start w-[60vw] space-y-6 rounded-br-lg bg-white p-4">
          <div onClick={() => salesperson.role === "admin" ? router.push('/admin') : router.push('/')} className="flex">
            <span>
              <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M11.293 3.293a1 1 0 0 1 1.414 0l6 6 2 2a1 1 0 0 1-1.414 1.414L19 12.414V19a2 2 0 0 1-2 2h-3a1 1 0 0 1-1-1v-3h-2v3a1 1 0 0 1-1 1H7a2 2 0 0 1-2-2v-6.586l-.293.293a1 1 0 0 1-1.414-1.414l2-2 6-6Z" clipRule="evenodd" />
